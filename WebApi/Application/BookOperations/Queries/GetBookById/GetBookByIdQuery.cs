...
namespace WebApi.Application.BookOperations.Queries.GetBookById
{
    public class GetBookByIdQuery
    {
        ...
        public GetBookByIdQuery(IBookStoreDbContext dbContext, IMapper mapper = null)
        {
        ...
        {
            Book book = _dbContext.Books.Include(x => x.Genre).Include(x => x.Author).FirstOrDefault(x => x.Id == Id);
            if (book is null)
